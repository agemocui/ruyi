...
pub fn read(chain: &mut ReadIter) -> io::Result<f64> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f64::little_endian::read"))
}
...
pub fn get(chain: &mut GetIter) -> io::Result<f64> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f64::little_endian::get"))
}
...
pub fn set(mut v: f64, chain: &mut SetIter) -> io::Result<usize> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f64::little_endian::set"))
}
