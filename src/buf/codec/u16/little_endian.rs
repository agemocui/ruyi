...
pub fn read(chain: &mut ReadIter) -> io::Result<u16> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u16::little_endian::read"))
}
...
pub fn get(chain: &mut GetIter) -> io::Result<u16> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u16::little_endian::get"))
}
...
pub fn set(mut v: u16, chain: &mut SetIter) -> io::Result<usize> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u16::little_endian::set"))
}
