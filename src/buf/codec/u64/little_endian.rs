...
pub fn read(chain: &mut ReadIter) -> io::Result<u64> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u64::little_endian::read"))
}
...
pub fn get(chain: &mut GetIter) -> io::Result<u64> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u64::little_endian::get"))
}
...
pub fn set(mut v: u64, chain: &mut SetIter) -> io::Result<usize> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u64::little_endian::set"))
}
