...
pub fn read(chain: &mut ReadIter) -> io::Result<u32> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u32::big_endian::read"))
}
...
pub fn get(chain: &mut GetIter) -> io::Result<u32> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u32::big_endian::get"))
}
...
pub fn set(mut v: u32, chain: &mut SetIter) -> io::Result<usize> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::u32::big_endian::set"))
}
