...
pub fn read(chain: &mut ReadIter) -> io::Result<f32> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f32::big_endian::read"))
}
...
pub fn get(chain: &mut GetIter) -> io::Result<f32> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f32::big_endian::get"))
}
...
pub fn set(mut v: f32, chain: &mut SetIter) -> io::Result<usize> {
    ...
    Err(Error::new(ErrorKind::UnexpectedEof, "codec::f32::big_endian::set"))
}
